...
void generateTriggers()
{
   ...
   rmTriggerAddScriptLine("      trRenderSnow(5);");
...
void generate()
{
   ...
   rmCustomMixAddPaintEntry(baseMixID, cTerrainNorseGrassDirt1, 2.0);
   rmCustomMixAddPaintEntry(baseMixID, cTerrainNorseSnowRocks1, 1.0);
   rmCustomMixAddPaintEntry(baseMixID, cTerrainNorseSnowDirt1, 4.0);
   ...
   rmCustomMixAddPaintEntry(pitMixID, cTerrainNorseDirtRocks2, 2.0);
   rmCustomMixAddPaintEntry(pitMixID, cTerrainNorseDirtRocks1, 3.0);
   rmCustomMixAddPaintEntry(pitMixID, cTerrainGreekDirt3, 2.0);
   rmCustomMixAddPaintEntry(pitMixID, cTerrainGreekDirt2, 2.0);
   rmCustomMixAddPaintEntry(pitMixID, cTerrainNorseDirt1, 2.0);
   
   int pitLayerMixID = rmCustomMixCreate();
   rmCustomMixSetPaintParams(pitLayerMixID, cNoiseFractalSum, 0.3, 5, 0.5);
   rmCustomMixAddPaintEntry(pitLayerMixID, cTerrainNorseDirtRocks1, 2.0);
   rmCustomMixAddPaintEntry(pitLayerMixID, cTerrainNorseSnowRocks1, 2.0);
   rmCustomMixAddPaintEntry(pitLayerMixID, cTerrainNorseDirt1, 2.0);
   rmCustomMixAddPaintEntry(pitLayerMixID, cTerrainNorseSnowDirt3, 3.0);
...
//   rmSetLighting(cLightingSetRmGoldRush01);
   ...
   rmAreaAddTerrainLayer(outerPitID, cTerrainNorseSnowDirt1, 0, 1);
   rmAreaAddTerrainLayer(outerPitID, cTerrainNorseSnowDirt2, 1, 2);
   rmAreaAddTerrainLayer(outerPitID, cTerrainNorseSnowDirt3, 2, 3);
   ...
   rmAreaSetCliffType(pitID, cCliffTundraDirt);
   if (gameIs1v1() == true)
   {
   ...
   for(int i = 1; i <= cNumberPlayers; i++)
   {
      ...
      for(int j = 0; j < numCliffsPerPlayer; j++)
      {
         ...
         rmAreaSetTerrainType(cliffID, cTerrainNorseSnowGrass1);
         rmAreaSetCliffType(cliffID, cCliffNorseSnowGrass);
   ...
   rmObjectDefAddItem(startingHuntID, cUnitTypeCaribou, xsRandInt(4, 5));
   rmObjectDefAddItem(startingHuntID, cUnitTypeElk, xsRandInt(3, 5));
   ...
   rmObjectDefAddItem(closeHuntID, cUnitTypeCaribou, xsRandInt(5, 9));
   ...
   {
      rmObjectDefAddItem(farHunt1ID, cUnitTypeDeer, xsRandInt(6, 10));
   }
   ...
   rmObjectDefAddItem(farHunt2ID, cUnitTypeCaribou, xsRandInt(2, 4));
   ...
   if (cMapSizeCurrent > cMapSizeStandard)
   {
      ...
      {
         rmObjectDefAddItem(largeMapHuntID, cUnitTypeDeer, xsRandInt(2, 4));
   ...
   rmObjectDefAddItem(bonusHerdID, cUnitTypeCow, xsRandInt(2, 3));
   ...
   int avoidCracked = rmCreateTerrainTypeDistanceConstraint(cTerrainHadesCracked1, 1.0);
   ...
   rmObjectDefAddConstraint(pitRelicID, avoidCracked);
   ...
   // Embellishment.
   // Gold areas.
   buildAreaUnderObjectDef(startingGoldID, cTerrainNorseSnowRocks2, cTerrainNorseSnowRocks1, 7.0);
   buildAreaUnderObjectDef(startingGoldSmallID, cTerrainNorseSnowRocks2, cTerrainNorseSnowRocks1, 7.0);
   buildAreaUnderObjectDef(bonusGoldID, cTerrainNorseSnowRocks2, cTerrainNorseSnowRocks1, 7.0);
   ...
   rmObjectDefPlaceAnywhere(randomTreePitID, 0, 6 * cNumberPlayers * getMapAreaSizeFactor());
