...
void generate()
{
   ...
   rmCustomMixAddPaintEntry(cliffMixID, cTerrainHadesDirt1, 1.0);
   rmCustomMixAddPaintEntry(cliffMixID, cTerrainHadesDirt2, 1.0);
   rmCustomMixAddPaintEntry(cliffMixID, cTerrainHadesDirtRocks1, 1.0);
   rmCustomMixAddPaintEntry(cliffMixID, cTerrainHadesDirtRocks2, 1.0);
   ...
   for(int i = 1; i <= cNumberPlayers; i++)
   {
      ...
      rmAreaSetCliffType(plateauID, cCliffHadesDirt);
   ...
   rmObjectDefAddItem(startingChickenID, cUnitTypeChickenEvil, xsRandInt(5, 8));
...
//   generateLocs("berries locs");
   ...
   rmObjectDefAddItem(relicID, cUnitTypeShadePredator, 3, 4.0);  
   ...
   rmAreaDefSetForestType(playerForestDefID, cForestHades);
   ...
   rmAreaDefSetForestType(globalForestDefID, cForestHades);
...
//   buildAreaUnderObjectDef(berriesID, cTerrainHadesDirt2, cTerrainHadesDirt1, 10.0);
   ...
   rmObjectDefAddConstraint(deadtreeID, vDefaultEmbellishmentAvoidImpassableLand);
   rmObjectDefAddConstraint(deadtreeID, vDefaultAvoidSettlementRange);
   rmObjectDefPlaceAnywhere(deadtreeID, 0, 5 * cNumberPlayers * getMapAreaSizeFactor());
